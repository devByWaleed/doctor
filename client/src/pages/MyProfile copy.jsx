...
const MyProfile = () => {
    ...
    // 2. Sync local state when Redux userData loads
    useEffect(() => {
        if (userData) {
        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
                    ...
                    <p className='font-medium'>Address:</p>
                    {
                        isEdit
                            ...
                            <p>
                                ...
                                <br />
                                <input className='bg-gray-50' type="text" value={userData.address.line2} onChange={(e) => setLocalUserData(prev => ({ ...prev, address: { ...prev.address, line2: e.target.value } }))} />
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600'>
                    <p className='font-medium'>Gender:</p>
                    {
                        isEdit
                            ? <select className='max-w-20 bg-gray-50'
                                onChange={(e) => setLocalUserData(prev => ({ ...prev, gender: e.target.value }))} value={localUserData.gender}>
                    ...
                    {
                        isEdit
                            ? <input className='max-w-28 bg-gray-50' type="date" value={localUserData.dob} onChange={(e) => setLocalUserData(prev => ({ ...prev, dob: e.target.value }))} />
